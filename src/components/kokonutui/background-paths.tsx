...
export const FloatingPaths = memo(function FloatingPaths({
  ...
  // ... (keep existing implementation of FloatingPaths)
...
export default memo(function BackgroundPaths({
  ...
  return (
    <div className={`relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-background ${className}`}>
